...
classify:
    ...
    # load m0
    lw a0, 4(s1)        
    addi a1, sp, 40     # pointer to the # of rows of m0
    addi a2, sp, 44     # pointer to the # of cols of m0
    jal ra, read_matrix
    mv s3, a0           # pointer to the start of m0
  
    # load m1
    lw a0, 8(s1)
    addi a1, sp, 48     # pointer to the # of rows of m1
    addi a2, sp, 52     # pointer to the # of cols of m0
    jal ra, read_matrix
    mv s4, a0           # pointer to the start of m1

    # load input matrix
    lw a0, 12(s1)
    addi a1, sp, 56     # pointer to the # of rows of input matrix
    addi a2, sp, 60     # pointer to the # of cols of input matrix
    jal ra, read_matrix
